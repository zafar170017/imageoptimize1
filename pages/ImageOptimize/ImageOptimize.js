    ...
    return (
        <div>
                ...
                }
            {
                ...
                <div className="head1">
                    <Heading element="h1" >Collecting  your all Product images</Heading>
               </div>
                <div className="bodytext">We are getting your media files. Please wait.</div>
                <br />
        ...
        }
        {
            ...
            <Page>
                    ...
                    <Layout>
                        <Layout.Section>
                            <Card sectioned>
                                <p>We have successfully Get Your Media Files</p>
                                <br />
